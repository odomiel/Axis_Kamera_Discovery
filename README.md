...
| Kamera manuell über IP hinzufügen | „Suchen"-Button ▸ „Kamera manuell hinzufügen…" | – |
...
- **Suchen** – startet die Suche im Hintergrund (Fenster bleibt bedienbar).
  ...
  wird dieselbe IP später per mDNS gefunden, ersetzt der Fund den manuellen Eintrag.
